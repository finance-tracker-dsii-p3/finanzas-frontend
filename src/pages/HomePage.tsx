...
export const HomePage: React.FC = () => {
    ...
    <div className="homepage-container min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="homepage-header text-center mb-16">
          <div className="flex justify-center mb-6">
            <img src="/horizontal.png" alt="eBalance" className="h-20 w-auto" />
          </div>
          <h1 className="homepage-title text-5xl font-bold text-gray-900 mb-4">
            Toma control de tus finanzas personales
          </h1>
          <p className="homepage-subtitle text-xl text-gray-600 max-w-3xl mx-auto mb-8">
          ...
          <div className="homepage-buttons flex gap-4 justify-center">
            <Link
              to="/register"
              className="homepage-button-primary bg-gradient-to-r from-blue-600 to-purple-600 text-white px-8 py-3 rounded-lg font-semibold hover:from-blue-700 hover:to-purple-700 transition-all shadow-lg hover:shadow-xl"
            >
              Comenzar gratis
            </Link>
            <Link
              to="/login"
              className="homepage-button-secondary bg-white text-blue-600 px-8 py-3 rounded-lg font-semibold border-2 border-blue-600 hover:bg-blue-50 transition-all"
            >
              Iniciar sesión
            </Link>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          <div className="homepage-feature-card bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div className="homepage-feature-icon w-12 h-12 bg-green-100 rounded-lg flex items-center justify-center mb-4">
          ...
          <div className="homepage-feature-card bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div className="homepage-feature-icon w-12 h-12 bg-purple-100 rounded-lg flex items-center justify-center mb-4">
          ...
          <div className="homepage-feature-card bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
            <div className="homepage-feature-icon w-12 h-12 bg-blue-100 rounded-lg flex items-center justify-center mb-4">
