            ...
            <div className="login-form-group">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className={`login-form-input w-full pl-10 pr-12 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${error ? 'login-form-input-error' : ''}`}
                  required
                  aria-required="true"
                  aria-invalid={!!error}
                />
